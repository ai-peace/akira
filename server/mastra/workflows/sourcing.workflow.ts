...
sourcingWorkflow
  ...
  .after(translateStep)
    .step(buildQueryAmiAmiStep)
    .then(pageCrawlerAmiAmiStep)
  .after([pageCrawlerAmiAmiStep])
  ...
  // .after([pageCrawlerMandarakeStep, pageCrawlerSurugayaStep, pageCrawlerTreasureFStep, pageCrawlerToysrusStep, pageCrawlerCardrushPokemonStep, pageCrawlerAmiamiStep])
