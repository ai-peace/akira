...
const Component: FC<Props> = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={form.handleSubmit(handleSubmit)} className="w-full">
      <div className="bg-background-muted md:border-border-strong relative flex-grow border p-2 md:rounded-2xl md:rounded-t-3xl md:bg-background md:p-4">
        <Textarea
          ...
          className="text-foreground-strong min-h-[24px] resize-none border-0 bg-transparent px-1 pb-10 pt-1 text-base shadow-none focus-visible:ring-0 md:pb-12 md:text-lg"
          style={{
            overflow:
