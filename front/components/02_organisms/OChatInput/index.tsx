import { OChatTextarea } from '@/front/components/02_organisms/OChatTextarea'
...
const Component: FC<Props> = ({ onSubmit }) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 mt-auto w-full">
      <div className="mx-auto flex flex-1 gap-4 text-base md:mb-4 md:max-w-3xl md:gap-5 lg:max-w-[40rem] lg:gap-6 xl:max-w-[48rem] 2xl:mx-auto">
