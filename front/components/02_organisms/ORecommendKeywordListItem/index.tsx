...
import { RecommendKeywordEntity } from '@/common/domains/entities/recommend-keyword.entity'
...
const Component: FC<Props> = ({ keyword, onClick, index = 0, isSubmitting = false }) => {
  ...
  return (
    <div
      className={cn(
        'bg-background-light text-foreground-strong hover:bg-background-muted flex cursor-pointer items-center overflow-hidden rounded-full border p-1 transition-colors duration-300',
