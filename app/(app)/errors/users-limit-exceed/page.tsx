    ...
    <div className="flex w-full items-center justify-center">
      <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4 text-center">
        ...
        <div className="mb-8 max-w-lg">
          <h1 className="text-foreground-strong mb-0 text-2xl font-bold md:text-3xl">
        ...
        <div className="flex flex-col gap-4 md:flex-row">
          <EDotButton
            href="/"
            text="Return to Home"
            className="bg-background-soft hover:bg-background-soft/90 w-[160px]"
          />
          <EDotButton
            href="/waitlists"
            text="Join Waitlist"
            className="bg-accent-1 hover:bg-accent-1/90 w-[160px]"
          />
        </div>
      </div>
    </div>
