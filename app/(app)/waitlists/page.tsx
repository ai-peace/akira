...
import { useCreateWaitList } from '@/front/hooks/resources/wait-list/useCreateWaitList'
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <div className="mb-8 max-w-lg text-center">
        <h1 className="text-foreground-strong mb-4 text-2xl font-bold md:text-3xl">
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="mx-auto w-full max-w-md space-y-4">
        <div className="space-y-2">
          <Input
            ...
            className="bg-background-soft h-12 rounded-full border-foreground px-6 text-foreground"
        ...
        <Button
          type="submit"
          className="bg-accent-1 hover:bg-accent-1/90 h-12 w-full rounded-full text-white"
          disabled={isSubmitting}
        >
